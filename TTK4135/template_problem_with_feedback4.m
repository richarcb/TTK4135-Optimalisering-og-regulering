...
%% Generate the matrix Q and the vector c (objecitve function weights in the SQP problem)
q1 = 1;
q2 = 1;
R = [q1 0;0 q2];
Q1 = [1 0 0 0 0 0;
...
%% Generate system matrixes for quadratic model
G = gen_q(Q1,R,N,M);
...
%% Gain matrix K for dlqr
Qk = diag([4 1 1 1 22 1]);
N1 = 0;
R = [q1 0;0 q2];
[K,S,E] = dlqr(A_d,B_d,Qk,R,N1);

%% Extract control inputs and states
u_pc  = [z(N*nx+1:nu:n);z(n-1)]; % Control input from solution
u_ec = [z(N*nx+2:nu:n);z(n)];
